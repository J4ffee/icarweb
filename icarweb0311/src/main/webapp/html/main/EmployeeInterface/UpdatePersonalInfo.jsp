...
<div id="nav" class="btn-group">
		<span class="label label-default">员工界面>>>修改个人信息</span>
	</div>
	...
	<div id="content">
		<h2>修改个人信息</h2>
		<p>原密码：<input type="password" style="margin-left: 24px;"></p>
		<p>修改密码：<input type="password" style="margin-left: 12px;"></p>
		<p>确认密码：<input type="password" style="margin-left: 12px;"></p>
		<p>修改手机号：<input type="text" ></p>
