...
<script type="text/javascript" src="./employeemanager.js"></script>
<script type="text/javascript" src="../../../html/admin/page/page.js"></script>
</head>
<body>
       <div id="nav" class="btn-group">
		<span class="label label-default">管理员界面>>>员工管理</span>
	</div>
	<div id="fun" class="btn-group" data-toggle="buttons-checkbox">
		...
		<input id="querydata" type="text" size="2" class="form-control" style="width: 30%" value="请输入查询关键字......">
	</div>
	<div id="content">
